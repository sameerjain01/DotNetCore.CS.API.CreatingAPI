...
namespace DotNetCore.CS.API.CreatingAPI.Migrations
{
    ...
    [Migration("20200126165553_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotNetCore.CS.API.CreatingAPI.Entities.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DotNetCore.CS.API.CreatingAPI.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DotNetCore.CS.API.CreatingAPI.Entities.Course", b =>
                {
                    b.HasOne("DotNetCore.CS.API.CreatingAPI.Entities.Author", "Author")
                        .WithMany("Courses")
